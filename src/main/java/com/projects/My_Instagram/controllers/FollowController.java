...
public class FollowController {
    ...
    public List<UserResponse> getFollowersOfUser(@PathVariable String username) {
        return followService.getFollowersOf(username);
    }

    @GetMapping("/{username}/following")
    public List<UserResponse> getFollowingOfUser(@PathVariable String username) {
        return followService.getFollowingOf(username);
    }
